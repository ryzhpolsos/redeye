...
namespace PowerSearch {
    ...
    public static class SuggestionManager {
        ...
        static List<SuggestionHandler> suggestions = new List<SuggestionHandler>();

        public static void RegisterHandler(SuggestionHandler handler){
            suggestions.Add(handler);
        }

        public static IEnumerable<ISuggestion> GetSuggestions(string input){
